...
select T.course_id , C.title from takes T,course C where T.course_id = C.course_id and id='12345';
...
select student.name,course.title,takes.year from student,course,takes,course,Section where student.id = takes.id and takes.year = Section.year and course.course_id = takes.course_id and section.roomnumber='303';